...
<head>
    <meta charset="UTF-8">
    <title>Report Lost Item | lost_and_found</title>
    <style>
        body {
...
<body>
    ...
    <script>
        ...
        document.getElementById('lostItemForm').addEventListener('submit', function(e) {
            const itemName = document.getElementById('lost_item_name').value.trim();
            const location = document.getElementById('lost_location').value.trim();
            const description = document.getElementById('lost_description').value.trim();
